        ...
        <div className="relative z-10 flex flex-col w-full min-h-[400px]">
          ...
          <div className="mt-auto relative z-10 w-full pt-2 flex flex-col sm:flex-row gap-5 sm:gap-4 items-center sm:items-center justify-between">
            <button 
              ...
              className="bg-gradient-to-r from-brand-orange to-brand-red text-white font-semibold px-8 py-3.5 rounded-[12px] hover:scale-[1.02] active:scale-95 transition-all shadow-[0_0_20px_rgba(255,69,0,0.3)] flex items-center justify-center gap-3 w-full sm:w-auto text-[14px] tracking-wide"
            >
              APPLY NOW
            ...
            <div className="flex flex-col sm:flex-row items-center justify-center w-full sm:w-auto gap-3 sm:gap-5 md:ml-auto">
              ...
              <div className="flex gap-2">
                <div className="flex flex-col items-center justify-center bg-white/5 border border-white/10 rounded-xl w-[52px] h-[52px] backdrop-blur-md shadow-[0_0_20px_rgba(255,69,0,0.15)] relative overflow-hidden group-hover:border-brand-orange/50 transition-colors">
