      ...
      <main id="main-content" className="pt-28 md:pt-32 pb-10 px-4 md:px-8 max-w-[1400px] mx-auto overflow-x-clip">
            ...
            <div className="flex flex-col text-left">
              ...
              <div className="flex flex-col sm:flex-row items-center justify-center gap-4 w-full sm:w-auto self-center lg:self-start">
                <button
                  ...
                  className="magnetic-btn w-full sm:w-auto flex items-center justify-center gap-2 px-8 py-3.5 rounded-xl bg-gradient-to-r from-brand-orange to-brand-red text-white font-semibold text-[15px] hover:scale-[1.02] active:scale-95 shadow-[0_0_20px_rgba(255,69,0,0.3)] cursor-pointer"
                >
        ...
        <section className="mt-10 mb-8 animate-reveal delay-100 w-full relative z-20">
          <style dangerouslySetInnerHTML={{ __html: `
            ...
            .mc.mc-open {
                ...
                box-shadow: 0 4px 18px rgba(255,85,0,0.07);
            }
            .dark .mc.mc-open {
                border-color: rgba(255,85,0,0.35);
                box-shadow: 0 4px 22px rgba(255,85,0,0.13);
            }
            .mc-btn {
                width: 100%;
                display: flex;
            ...
            .mc-btn:hover .mc-title { color: #FF5500; }
            .mc-chevron {
                flex-shrink: 0;
                width: 22px;
                height: 22px;
            ...
            .mc.mc-open .mc-chevron { transform: rotate(90deg); background: #FF5500; border-color: transparent; color: #fff; }
            .mc-body {
                max-height: 0;
                overflow: hidden;
            ...
            #bracket-active, #timeline-progress-ticks {
                filter: drop-shadow(0 0 4px rgba(255,85,0,0.8)) drop-shadow(0 0 2px rgba(255,17,0,1));
            }
        ...
        <section id="curriculum" className="mt-16 mb-20 animate-reveal delay-200 w-full relative z-20">
              ...
              <svg className="absolute left-[4px] md:left-[14px] top-2 bottom-2 w-5 md:w-14 h-[calc(100%-16px)] pointer-events-none overflow-visible curr-rail-svg" xmlns="http://www.w3.org/2000/svg">
                <defs>
                  ...
                  <pattern id="ticks-active" width="28" height="6" patternUnits="userSpaceOnUse">
                    <line x1="0" y1="2" x2="18" y2="2" stroke="#FF5500" strokeWidth="1.5" />
                  </pattern>
                ...
                <g stroke="#FF5500" id="bracket-active" className="transition-opacity duration-150 hidden md:block opacity-0">
                ...
                <div className="flex items-center gap-4 pb-5 border-b border-zinc-200/60 dark:border-white/[0.06] mb-5">
                  <div className="relative flex items-center justify-center shrink-0 w-[52px] h-[52px]">
                    <svg className="w-full h-full progress-circle-svg transform -rotate-90" viewBox="0 0 40 40">
                      ...
                      <circle id="progress-circle" cx="20" cy="20" r="18" fill="none" stroke="#FF5500" strokeWidth="3" strokeDasharray="113.1" strokeDashoffset="113.1" strokeLinecap="round" className="transition-all duration-300" style={{ filter: "drop-shadow(0 0 3px rgba(255,85,0,0.85))" }} />
                    </svg>
          ...
          <div className="mt-8 flex justify-center lg:hidden">
            <button className="px-6 py-3 rounded-xl bg-gradient-to-r from-brand-orange to-brand-red text-white font-semibold text-sm hover:scale-[1.02] active:scale-95 transition-all duration-200 shadow-[0_0_18px_rgba(255,69,0,0.22)] hover:shadow-[0_0_28px_rgba(255,69,0,0.4)]" onClick={openCounseling}>
            ...
            <div className="grid grid-cols-1 lg:grid-cols-5 gap-12 lg:gap-16 items-center">
              ...
              <div className="lg:col-span-3 flex flex-col justify-center space-y-8 relative z-10">
                ...
                <div className="pt-4 border-t border-zinc-100 dark:border-white/5">
                  <button
                    onClick={openCounseling}
                    className="magnetic-btn w-full sm:w-auto flex items-center justify-center gap-2 px-8 py-3.5 rounded-xl bg-gradient-to-r from-brand-orange to-brand-red text-white font-semibold text-[15px] hover:scale-[1.02] active:scale-95 shadow-[0_4px_20px_rgba(255,69,0,0.3)] cursor-pointer"
                  >
                    Talk to Program Advisor
                  </button>
                </div>
