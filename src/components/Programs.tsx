...
const programs: Program[] = [
  ...
  },
  {
    ...
    includes: [
      ...
      { name: 'Workflow Automation', icon: <svg width="12" height="12" viewBox="0 0 24 24" fill="none" stroke="currentColor" strokeWidth="2.5"><circle cx="12" cy="12" r="10"/><path d="m9 12 2 2 4-4"/></svg> },
      { name: 'Chatbots', icon: <svg width="12" height="12" viewBox="0 0 24 24" fill="none" stroke="currentColor" strokeWidth="2.5"><rect x="2" y="3" width="20" height="14" rx="2" ry="2"/><line x1="8" y1="21" x2="16" y2="21"/><line x1="12" y1="17" x2="12" y2="21"/></svg> },
      { name: 'LLM Apps', icon: <svg width="12" height="12" viewBox="0 0 24 24" fill="none" stroke="currentColor" strokeWidth="2.5"><circle cx="12" cy="12" r="10"/><path d="m9 12 2 2 4-4"/></svg> },
      { name: 'AI Product Building', icon: <svg width="12" height="12" viewBox="0 0 24 24" fill="none" stroke="currentColor" strokeWidth="2.5"><path d="m12 3-1.912 5.813a2 2 0 0 1-1.275 1.275L3 12l5.813 1.912a2 2 0 0 1 1.275 1.275L12 21l1.912-5.813a2 2 0 0 1 1.275-1.275L21 12l-5.813-1.912a2 2 0 0 1-1.275-1.275L12 3Z"/></svg> },
    ],
  ...
  },
  {
    ...
    description: 'Learn modern frontend, backend, database, API, and cloud deployment skills used by startups and SaaS companies at SkillSha.',
    duration: '20 Weeks',
    salary: '₹12L+',
    svgBg: (
  ...
  },
  {
    ...
    includes: [
      { name: 'Product Strategy', icon: <svg width="12" height="12" viewBox="0 0 24 24" fill="none" stroke="currentColor" strokeWidth="2.5"><path d="M21 16V8a2 2 0 0 0-1-1.73l-7-4a2 2 0 0 0-2 0l-7 4A2 2 0 0 0 3 8v8a2 2 0 0 0 1 1.73l7 4a2 2 0 0 0 2 0l7-4A2 2 0 0 0 21 16z"/></svg> },
      { name: 'User Research', icon: <svg width="12" height="12" viewBox="0 0 24 24" fill="none" stroke="currentColor" strokeWidth="2.5"><circle cx="12" cy="12" r="10"/><path d="m9 12 2 2 4-4"/></svg> },
      { name: 'Analytics', domain: 'analytics.google.com' },
      { name: 'Roadmapping', icon: <svg width="12" height="12" viewBox="0 0 24 24" fill="none" stroke="currentColor" strokeWidth="2.5"><path d="M21 16V8a2 2 0 0 0-1-1.73l-7-4a2 2 0 0 0-2 0l-7 4A2 2 0 0 0 3 8v8a2 2 0 0 0 1 1.73l7 4a2 2 0 0 0 2 0l7-4A2 2 0 0 0 21 16z"/></svg> },
      { name: 'Growth Systems', icon: <svg width="12" height="12" viewBox="0 0 24 24" fill="none" stroke="currentColor" strokeWidth="2.5"><polyline points="22 7 13.5 15.5 8.5 10.5 2 17"/><polyline points="16 7 22 7 22 13"/></svg> },
      { name: 'Agile', icon: <svg width="12" height="12" viewBox="0 0 24 24" fill="none" stroke="currentColor" strokeWidth="2.5"><path d="M21 16V8a2 2 0 0 0-1-1.73l-7-4a2 2 0 0 0-2 0l-7 4A2 2 0 0 0 3 8v8a2 2 0 0 0 1 1.73l7 4a2 2 0 0 0 2 0l7-4A2 2 0 0 0 21 16z"/></svg> },
    ],
  ...
  },
  {
    ...
    includes: [
      { name: 'Quant Strategies', icon: <svg width="12" height="12" viewBox="0 0 24 24" fill="none" stroke="currentColor" strokeWidth="2.5"><rect x="2" y="3" width="20" height="14" rx="2" ry="2"/><line x1="8" y1="21" x2="16" y2="21"/><line x1="12" y1="17" x2="12" y2="21"/></svg> },
      { name: 'Trading Bots', icon: <svg width="12" height="12" viewBox="0 0 24 24" fill="none" stroke="currentColor" strokeWidth="2.5"><rect x="2" y="3" width="20" height="14" rx="2" ry="2"/><line x1="8" y1="21" x2="16" y2="21"/><line x1="12" y1="17" x2="12" y2="21"/></svg> },
      { name: 'Financial Data', icon: <svg width="12" height="12" viewBox="0 0 24 24" fill="none" stroke="currentColor" strokeWidth="2.5"><path d="M3 3v18h18"/><path d="m19 9-5 5-4-4-3 3"/></svg> },
      { name: 'Risk Management', icon: <svg width="12" height="12" viewBox="0 0 24 24" fill="none" stroke="currentColor" strokeWidth="2.5"><rect x="2" y="3" width="20" height="14" rx="2" ry="2"/><line x1="8" y1="21" x2="16" y2="21"/><line x1="12" y1="17" x2="12" y2="21"/></svg> },
      { name: 'Python', domain: 'python.org' },
      { name: 'Automation', icon: <svg width="12" height="12" viewBox="0 0 24 24" fill="none" stroke="currentColor" strokeWidth="2.5"><path d="M12 8V4H8"/><rect width="16" height="12" x="4" y="8" rx="2"/><path d="M2 14h2"/><path d="M20 14h2"/><path d="M15 13v2"/><path d="M9 13v2"/></svg> },
    ],
  ...
  },
  {
    ...
    includes: [
      ...
      { name: 'Figma', domain: 'figma.com' },
      { name: 'Brand Identity', icon: <svg width="12" height="12" viewBox="0 0 24 24" fill="none" stroke="currentColor" strokeWidth="2.5"><path d="M12 22s8-4 8-10V5l-8-3-8 3v7c0 6 8 10 8 10z"/></svg> },
      { name: 'Typography', icon: <svg width="12" height="12" viewBox="0 0 24 24" fill="none" stroke="currentColor" strokeWidth="2.5"><polyline points="4 7 4 4 20 4 20 7"/><line x1="9" y1="20" x2="15" y2="20"/><line x1="12" y1="4" x2="12" y2="20"/></svg> },
      { name: 'Visual Hierarchy', icon: <svg width="12" height="12" viewBox="0 0 24 24" fill="none" stroke="currentColor" strokeWidth="2.5"><line x1="3" y1="6" x2="21" y2="6"/><line x1="3" y1="12" x2="15" y2="12"/><line x1="3" y1="18" x2="9" y2="18"/></svg> },
    ],
  ...
  },
  {
    ...
    icon: 'database',
    title: 'Data Analyst',
    subtitle: 'Master PowerBI & Excel',
    description: 'Learn to clean, model, and visualize data using Excel, SQL, and PowerBI, optimized with AI analytic workflows.',
    duration: '16 Weeks',
    salary: '₹7.2L+',
    svgBg: (
      <svg className="w-20 h-20 text-brand-orange/[0.08] dark:text-brand-orange/[0.05] mr-[-10px] mt-[-5px] animate-pulse-soft" viewBox="0 0 100 100" fill="none" stroke="currentColor" strokeWidth="1.2">
    ...
    includes: [
      { name: 'Excel Sheets', domain: 'microsoft.com' },
      { name: 'SQL Databases', domain: 'postgresql.org' },
      { name: 'PowerBI', domain: 'powerbi.microsoft.com' },
      { name: 'DAX Measures', domain: 'microsoft.com' },
      { name: 'Python Pandas', domain: 'pandas.pydata.org' },
      { name: 'AI Assistants', domain: 'openai.com' }
    ],
    professions: ['developer', 'ca', 'corporate']
  },
  {
    id: 'business-analyst',
    icon: 'route',
    title: 'Business Analyst',
    subtitle: 'Bridge Business & Tech',
    description: 'Master user stories, Jira Agile backlog, database querying, and requirements analysis, optimized with AI productivity suites.',
    duration: '16 Weeks',
    salary: '₹6.8L+',
    svgBg: (
      <svg className="w-20 h-20 text-brand-orange/[0.08] dark:text-brand-orange/[0.05] mr-[-10px] mt-[-5px] animate-float" viewBox="0 0 100 100" fill="none" stroke="currentColor" strokeWidth="1.2">
    ...
    includes: [
      { name: 'Jira Software', domain: 'atlassian.com' },
      { name: 'Confluence', domain: 'atlassian.com' },
      { name: 'Miro Boards', domain: 'miro.com' },
      { name: 'SQL Databases', domain: 'postgresql.org' },
      { name: 'Excel Metrics', domain: 'microsoft.com' },
      { name: 'AI Copy Spec', domain: 'openai.com' }
    ],
    professions: ['corporate']
  },
  {
    id: 'ai-ml-with-gen-ai',
    icon: 'memory',
    title: 'AI/ML with Gen AI',
    subtitle: 'Train Neural Networks & ML Models',
    description: 'Deep dive into model training, neural network architectures, and deep learning algorithms using TensorFlow, PyTorch, and Keras.',
    duration: '24 Weeks',
    salary: '₹10.5L+',
    svgBg: (
      <svg className="w-20 h-20 text-brand-orange/[0.08] dark:text-brand-orange/[0.05] mr-[-10px] mt-[-5px] animate-spin-slow" viewBox="0 0 100 100" fill="none" stroke="currentColor" strokeWidth="1.2">
    ...
    mobileIcon: (
      <svg xmlns="http://www.w3.org/2000/svg" width="24" height="24" viewBox="0 0 24 24" fill="none" stroke="currentColor" strokeWidth="2" strokeLinecap="round" strokeLinejoin="round" className="text-brand-orange"><rect x="2" y="2" width="20" height="20" rx="2.18" ry="2.18"/><line x1="1" y1="20" x2="23" y2="20"/><line x1="1" y1="4" x2="23" y2="4"/><line x1="12" y1="4" x2="12" y2="20"/></svg>
    ),
    includes: [
      { name: 'PyTorch Core', domain: 'pytorch.org' },
      { name: 'TensorFlow', domain: 'tensorflow.org' },
      { name: 'Keras Models', domain: 'keras.io' },
      { name: 'Scikit-Learn', domain: 'scikit-learn.org' },
      { name: 'FastAPI Serving', domain: 'fastapi.tiangolo.com' },
      { name: 'Docker Labs', domain: 'docker.com' }
    ],
    professions: ['developer', 'ca', 'doctor', 'corporate']
  },
  {
    ...
    subtitle: 'Master QA & Automation',
    description: 'Learn manual testing, test case design, API validation, and automated QA suites using Selenium, Postman, and Jira.',
    duration: '16 Weeks',
    salary: '₹6.2L+',
    svgBg: (
      <svg className="w-20 h-20 text-brand-orange/[0.08] dark:text-brand-orange/[0.05] mr-[-10px] mt-[-5px] animate-float" viewBox="0 0 100 100" fill="none" stroke="currentColor" strokeWidth="1.2">
    ...
    mobileIcon: (
      <svg xmlns="http://www.w3.org/2000/svg" width="24" height="24" viewBox="0 0 24 24" fill="none" stroke="currentColor" strokeWidth="2" strokeLinecap="round" strokeLinejoin="round" className="text-rose-500"><rect x="3" y="11" width="18" height="10" rx="2"/><path d="M12 2v9"/><path d="M8 5h8"/></svg>
    ),
    includes: [
      { name: 'Manual Testing', icon: <svg width="12" height="12" viewBox="0 0 24 24" fill="none" stroke="currentColor" strokeWidth="2.5"><path d="m9 12 2 2 4-4"/></svg> },
      { name: 'Selenium WebDriver', domain: 'selenium.dev' },
      { name: 'Postman APIs', domain: 'postman.com' },
      { name: 'Java & JS Core', domain: 'oracle.com' },
      { name: 'Jira Defects', domain: 'atlassian.com' },
      { name: 'AI Test Cases', domain: 'openai.com' }
    ],
  ...
  },
  {
    ...
    subtitle: 'Next-Gen Async Test Automation',
    description: 'Master modern async web testing, trace analyses, and network intercepts using Playwright, JavaScript/TypeScript, and CI/CD.',
    duration: '12 Weeks',
    salary: '₹6.8L+',
    svgBg: (
      <svg className="w-20 h-20 text-brand-orange/[0.08] dark:text-brand-orange/[0.05] mr-[-10px] mt-[-5px] animate-spin-slow" viewBox="0 0 100 100" fill="none" stroke="currentColor" strokeWidth="1.2">
    ...
    mobileIcon: (
      <svg xmlns="http://www.w3.org/2000/svg" width="24" height="24" viewBox="0 0 24 24" fill="none" stroke="currentColor" strokeWidth="2" strokeLinecap="round" strokeLinejoin="round" className="text-emerald-500"><polyline points="22 12 18 12 15 21 9 3 6 12 2 12"/></svg>
    ),
    includes: [
      { name: 'Playwright Core', domain: 'playwright.dev' },
      { name: 'TypeScript Core', domain: 'typescriptlang.org' },
      { name: 'Async Javascript', domain: 'javascript.info' },
      { name: 'API Mock Intercept', domain: 'playwright.dev' },
      { name: 'Trace Diagnostics', domain: 'playwright.dev' },
      { name: 'GitHub Actions CI', domain: 'github.com' }
    ],
    professions: ['developer']
  },
  {
    id: 'ai-healthcare-doctor',
    icon: 'medical_services',
    title: 'AI for Doctors',
    subtitle: 'Clinical AI Masterclass',
    ...
    includes: [
      { name: 'Clinical Prompting', domain: 'openai.com' },
      { name: 'HIPAA Charting', icon: <svg width="12" height="12" viewBox="0 0 24 24" fill="none" stroke="currentColor" strokeWidth="2.5"><path d="M12 22s8-4 8-10V5l-8-3-8 3v7c0 6 8 10 8 10z"/></svg> },
      { name: 'PubMed Agents', domain: 'nih.gov' },
      { name: 'EHR Automation', icon: <svg width="12" height="12" viewBox="0 0 24 24" fill="none" stroke="currentColor" strokeWidth="2.5"><path d="M12 22s8-4 8-10V5l-8-3-8 3v7c0 6 8 10 8 10z"/></svg> },
      { name: 'Medical Search', domain: 'nih.gov' },
      { name: 'Secure LLMs', domain: 'anthropic.com' }
    ],
    professions: ['doctor']
  },
  {
    id: 'ai-clinical-nurse',
    icon: 'local_hospital',
    title: 'AI for Nurses',
    subtitle: 'Shift & Care Automation',
    description: 'Save 15+ hours weekly on charting, shift handovers, and patient care planning using secure AI clinical tools.',
    duration: '8 Weeks',
    salary: 'Time-Saving',
    svgBg: (
      <svg className="w-20 h-20 text-brand-orange/[0.08] dark:text-brand-orange/[0.05] mr-[-10px] mt-[-5px] animate-float" viewBox="0 0 100 100" fill="none" stroke="currentColor" strokeWidth="1.2">
    ...
    mobileIcon: (
      <svg xmlns="http://www.w3.org/2000/svg" width="24" height="24" viewBox="0 0 24 24" fill="none" stroke="currentColor" strokeWidth="2" strokeLinecap="round" strokeLinejoin="round" className="text-teal-500"><path d="M12 2v20M2 12h20"/></svg>
    ),
    includes: [
      { name: 'SBAR Handovers', icon: <svg width="12" height="12" viewBox="0 0 24 24" fill="none" stroke="currentColor" strokeWidth="2.5"><path d="m9 12 2 2 4-4"/></svg> },
      { name: 'Care Planning', icon: <svg width="12" height="12" viewBox="0 0 24 24" fill="none" stroke="currentColor" strokeWidth="2.5"><path d="m9 12 2 2 4-4"/></svg> },
      { name: 'Smart Charting', domain: 'openai.com' },
      { name: 'Shift Notes', domain: 'anthropic.com' },
      { name: 'Clinical AI', domain: 'nih.gov' },
      { name: 'Time-Saving Labs', icon: <svg width="12" height="12" viewBox="0 0 24 24" fill="none" stroke="currentColor" strokeWidth="2.5"><path d="M12 22s8-4 8-10V5l-8-3-8 3v7c0 6 8 10 8 10z"/></svg> }
    ],
    professions: ['nurse']
  },
  {
    ...
    mobileIcon: (
      <svg xmlns="http://www.w3.org/2000/svg" width="24" height="24" viewBox="0 0 24 24" fill="none" stroke="currentColor" strokeWidth="2" strokeLinecap="round" strokeLinejoin="round" className="text-emerald-500"><rect x="2" y="2" width="20" height="20" rx="2.18" ry="2.18"/><line x1="12" y1="18" x2="12" y2="6"/><line x1="6" y1="12" x2="18" y2="12"/></svg>
    ),
    includes: [
      { name: 'Tax Auditing', icon: <svg width="12" height="12" viewBox="0 0 24 24" fill="none" stroke="currentColor" strokeWidth="2.5"><path d="m9 12 2 2 4-4"/></svg> },
      { name: 'Excel Formulas', domain: 'microsoft.com' },
      { name: 'Invoice Parsing', domain: 'openai.com' },
      { name: 'Spreadsheet Agents', domain: 'anthropic.com' },
      { name: 'Financial LLMs', domain: 'google.com' },
      { name: 'Practice Scaling', icon: <svg width="12" height="12" viewBox="0 0 24 24" fill="none" stroke="currentColor" strokeWidth="2.5"><path d="M12 22s8-4 8-10V5l-8-3-8 3v7c0 6 8 10 8 10z"/></svg> }
    ],
    professions: ['ca', 'corporate']
  }
];
