      ...
      <nav className="md:hidden fixed bottom-6 left-4 right-4 z-50 bg-[#FAF9F6] dark:bg-[#050505] border border-zinc-200/80 dark:border-white/10 rounded-2xl shadow-xl dark:shadow-[0_10px_30px_rgba(0,0,0,0.8)]">
        <div className="flex justify-around items-center h-16 px-2">
          {isLoggedIn ? (
            ...
            <>
              <Link href="tel:+918888988789" className="flex flex-col items-center justify-center w-16 h-full text-zinc-500 dark:text-zinc-400 hover:text-zinc-900 dark:hover:text-white transition-colors">
