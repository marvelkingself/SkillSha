const USPS = [
  {
    q: "Does SkillSha offer real, project-based learning?",
    a: "Yes. Every SkillSha course is 100% project-based — students ship deployed, portfolio-ready applications instead of completing theoretical assignments.",
    icon: (
  ...
  {
    q: "Who trains students at SkillSha?",
    a: "SkillSha's trainers are working industry professionals who've built production systems at companies like OpenAI, Meta, and Stripe — not just classroom instructors.",
    icon: (
      <svg className="w-5 h-5 text-brand-orange" fill="none" stroke="currentColor" strokeWidth="2" viewBox="0 0 24 24">
  ...
  {
    q: "Are SkillSha batch timings flexible?",
    a: "Yes. SkillSha runs weekday and weekend batches across all cities it serves, with session recordings provided for anyone who misses a live class.",
    icon: (
      <svg className="w-5 h-5 text-brand-orange" fill="none" stroke="currentColor" strokeWidth="2" viewBox="0 0 24 24">
