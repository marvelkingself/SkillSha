    ...
    <>
      <section id="hero" className="grid grid-cols-1 lg:grid-cols-2 gap-8 lg:gap-12 items-center animate-reveal active">
        <div className="flex flex-col justify-center">
          ...
          <h1 className="text-4xl sm:text-5xl lg:text-5xl font-semibold tracking-tight leading-[1.1] mb-4">
          ...
          <button 
            ...
            className="magnetic-btn relative inline-flex items-center justify-center gap-2.5 px-6 py-3.5 rounded-xl bg-gradient-to-r from-brand-orange to-brand-red text-white font-semibold text-base overflow-hidden transition-all hover:scale-[1.02] active:scale-95 w-full sm:w-fit shadow-[0_0_20px_rgba(255,69,0,0.3)]"
          >
        ...
        <div className="relative group perspective-1000 w-full">
          <div className="relative w-full aspect-video rounded-2xl overflow-hidden glass-panel p-1 transform transition-all duration-700 hover:shadow-[0_0_40px_rgba(255,69,0,0.2)] border-zinc-200 dark:border-white/10 group-hover:border-brand-orange/50">
            <div 
              ...
              {videoOpen ? (
                <div className="relative w-full h-full group/video">
                  ...
                  >
                    ...
                    <div className={`w-14 h-14 md:w-16 md:h-16 rounded-full bg-transparent border border-white/30 dark:border-white/10 flex items-center justify-center transition-all duration-300 hover:scale-110 hover:border-brand-orange/60 hover:shadow-[0_0_20px_rgba(255,85,0,0.2)] transform ${
                      isPlaying 
                      ...
                      {isPlaying ? (
                        /* Pause icon */
                        <svg className="w-6 h-6 md:w-7 md:h-7 text-brand-orange drop-shadow-[0_2px_8px_rgba(255,85,0,0.3)]" fill="currentColor" viewBox="0 0 24 24">
                          <path d="M6 19h4V5H6v14zm8-14v14h4V5h-4z"/>
                        </svg>
                      ) : (
                        /* Play icon */
                        <svg className="w-6 h-6 md:w-7 md:h-7 text-brand-orange ml-0.5 drop-shadow-[0_2px_8px_rgba(255,85,0,0.3)]" fill="currentColor" viewBox="0 0 24 24">
                ...
                >
                  ...
                  <div className="absolute inset-0 z-20 flex flex-col items-center justify-center pointer-events-none">
                      <div className="w-14 h-14 md:w-16 md:h-16 rounded-full bg-transparent border border-white/30 dark:border-white/10 flex items-center justify-center transition-all duration-500 group-hover:scale-110 group-hover:border-brand-orange/60 group-hover:shadow-[0_0_20px_rgba(255,85,0,0.2)]">
                          <svg className="w-6 h-6 md:w-7 md:h-7 text-brand-orange ml-0.5 drop-shadow-[0_2px_8px_rgba(255,85,0,0.3)]" fill="currentColor" viewBox="0 0 24 24"><path d="M8 5v14l11-7z"/></svg>
                      </div>
                  </div>
