...
async function renderTest() {
  const svg = createBlueAbstractSVG("Full Stack Developer Roadmap 2025", "Full-Stack Dev");
  const outPath = path.join(__dirname, "..", "public", "test-blue-theme-preview.png");
  await sharp(Buffer.from(svg)).png().toFile(outPath);
  console.log("Saved test blue theme preview to:", outPath);
}
